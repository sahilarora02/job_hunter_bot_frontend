    ...
    try {
      const response = await fetch('https://api.getknit.ai/v1/router/run', {
        ...
        headers: {
          ...
          'x-auth-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiMTE1NzE0MTk4OTE2NzMzNjQxMTc5In0sImlhdCI6MTcwNjc4ODI0NCwiZXhwIjoxNzA3ODY4MjQ0fQ.pzfEzxhFCO25BC6yLXJK7v7paDVkd5z9yB8bvmqOSF0',
        },
        body: JSON.stringify({
          messages: [
            {
