...
const JobSummary = () => {
  ...
  const handleSummarize = async () => {
    ...
    try {
      const response = await fetch('https://api.getknit.ai/v1/router/run', {
        method: 'POST',
        headers: {
          'x-auth-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiMTE1NzE0MTk4OTE2NzMzNjQxMTc5In0sImlhdCI6MTcwNjc4ODI0NCwiZXhwIjoxNzA3ODY4MjQ0fQ.pzfEzxhFCO25BC6yLXJK7v7paDVkd5z9yB8bvmqOSF0', // Replace with your actual auth token
        ...
        body: JSON.stringify({
          messages: [
            {
              role: 'system',
              content: 'You are a helpful Assistant, and an expert of companies',
            },
            {
              role: 'user',
  ...
  return (
    <div style={styles.container}>
      ...
      />
      <button style={styles.summarizeButton} onClick={handleSummarize} disabled={isLoading}>
